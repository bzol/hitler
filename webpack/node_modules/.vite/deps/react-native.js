import {
  require_client
} from "./chunk-BYUNVNW6.js";
import {
  require_react_dom
} from "./chunk-5D3MTBTK.js";
import {
  __commonJS,
  __esm,
  __export,
...
var VirtualizedList = class extends StateSafePureComponent {
      ...
      var renderProp = (info) => {
        if (cols > 1) {
          ...
          return React15.createElement(View_default, {
            style: StyleSheet_default.compose(styles6.row, columnWrapperStyle)
          }, _item2.map((it, kk) => {
            var element = render2({
